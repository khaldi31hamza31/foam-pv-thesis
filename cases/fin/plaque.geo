...
// ---- MAILLAGE FIN (verification d'independance au maillage) ----
// Toutes les tailles de maille divisees par ~2 par rapport a plaque.geo :
// si kN ne change presque pas entre les deux, le maillage grossier etait
// deja suffisant (test standard, comme les MOD1-4 de Raciti Castelli et al.)
lc_plate = 0.004*b;       // taille de maille pres de la plaque (etait 0.008*b)
lc_far   = 0.4*b;         // taille de maille loin (etait 0.8*b)
